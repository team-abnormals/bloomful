...
public class TrappedChestBlock extends net.minecraft.block.TrappedChestBlock {
    ...
    public static void provideItemBlock(Item.Properties properties) {
        ChestBlock.setTEISR(properties, new ResourceLocation("bloomful", "textures/model/chest/wisteria_normal.png"), new ResourceLocation("bloomful", "textures/model/chest/wisteria_double.png"));
    }
}