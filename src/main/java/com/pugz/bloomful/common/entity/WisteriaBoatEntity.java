...
public class WisteriaBoatEntity extends BoatEntity {
   ...
   private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.createKey(WisteriaBoatEntity.class, DataSerializers.FLOAT);
   private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.createKey(WisteriaBoatEntity.class, DataSerializers.VARINT);
   private static final DataParameter<Boolean> field_199704_e = EntityDataManager.createKey(WisteriaBoatEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Boolean> field_199705_f = EntityDataManager.createKey(WisteriaBoatEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Integer> ROCKING_TICKS = EntityDataManager.createKey(WisteriaBoatEntity.class, DataSerializers.VARINT);
   ...
   public WisteriaBoatEntity(EntityType<? extends WisteriaBoatEntity> p_i50129_1_, World p_i50129_2_) {
      super(p_i50129_1_, p_i50129_2_);
      this.preventEntitySpawning = true;
   }

   public WisteriaBoatEntity(World worldIn, double x, double y, double z) {
      this(BloomfulEntities.BOAT, worldIn);
   ...
   protected void registerData() {
      ...
      this.dataManager.register(BOAT_TYPE, WisteriaBoatEntity.Type.WISTERIA.ordinal());
   ...
   protected void readAdditional(CompoundNBT compound) {
      if (compound.contains("Type", 8)) {
         this.setBoatType(WisteriaBoatEntity.Type.getTypeFromString(compound.getString("Type")));
      }
   ...
   public void setBoatType(WisteriaBoatEntity.Type boatType) {
      this.dataManager.set(BOAT_TYPE, boatType.ordinal());
   }

   public WisteriaBoatEntity.Type getBoatModel() {
      return WisteriaBoatEntity.Type.byId(this.dataManager.get(BOAT_TYPE));
   }
   ...
   public static enum Type {
       ...
       */
      public static WisteriaBoatEntity.Type byId(int id) {
    	  WisteriaBoatEntity.Type[] aboatentity$type = values();
      ...
      public static WisteriaBoatEntity.Type getTypeFromString(String nameIn) {
    	  WisteriaBoatEntity.Type[] aboatentity$type = values();
