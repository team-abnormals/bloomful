...
public class WisteriaBoatItem extends Item {
    private static final Predicate<Entity> field_219989_a = EntityPredicates.NOT_SPECTATING.and(Entity::canBeCollidedWith);
    private final WisteriaBoatEntity.Type type;

    public WisteriaBoatItem(WisteriaBoatEntity.Type typeIn, Item.Properties properties) {
        super(properties);
        type = typeIn;
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
                WisteriaBoatEntity boatentity = new WisteriaBoatEntity(worldIn, raytraceresult.getHitVec().x, raytraceresult.getHitVec().y, raytraceresult.getHitVec().z);
    ...
    static class DispenserBoatBehavior extends DefaultDispenseItemBehavior {
        ...
        public DispenserBoatBehavior(WisteriaBoatEntity.Type typeIn) {
            type = typeIn;
        }
        ...
        public ItemStack dispenseStack(IBlockSource iBlockSource, ItemStack stack) {
            ...
            WisteriaBoatEntity boat = new WisteriaBoatEntity(world, x, y + adjustY, z);
