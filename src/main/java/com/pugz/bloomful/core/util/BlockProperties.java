...
public class BlockProperties {
    ...
    public static Block.Properties WISTERIA_DOORS = Block.Properties.create(Material.WOOD, MaterialColor.WHITE_TERRACOTTA).notSolid().hardnessAndResistance(3.0F).sound(SoundType.WOOD);
    ...
    public static Block.Properties LADDER = Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.4F).notSolid().sound(SoundType.LADDER);
}