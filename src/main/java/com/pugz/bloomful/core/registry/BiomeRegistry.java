...
public class BiomeRegistry {
    ...
    public static Biome WISTERIA_FOREST_HILLS = new WisteriaForestHillsBiome(new Biome.Builder().surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG).precipitation(Biome.RainType.RAIN).category(Biome.Category.FOREST).depth(0.45F).scale(0.3F).temperature(0.7F).downfall(0.8F).waterColor(4159204).waterFogColor(329011).parent(null)).setRegistryName("wisteria_forest");
