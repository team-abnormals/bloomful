...
public class BloomfulBlocks {
    ...
    public static final RegistryObject<Block> PINK_WISTERIA_LEAVES 			= RegistryUtils.createBlock("pink_wisteria_leaves", () -> new LeavesBlock(BlockProperties.WISTERIA_LEAVES(MaterialColor.PINK)), ItemGroup.DECORATIONS);
    public static final RegistryObject<Block> BLUE_WISTERIA_LEAVES 			= RegistryUtils.createBlock("blue_wisteria_leaves", () -> new LeavesBlock(BlockProperties.WISTERIA_LEAVES(MaterialColor.BLUE)), ItemGroup.DECORATIONS);
    public static final RegistryObject<Block> PURPLE_WISTERIA_LEAVES 		= RegistryUtils.createBlock("purple_wisteria_leaves", () -> new LeavesBlock(BlockProperties.WISTERIA_LEAVES(MaterialColor.PURPLE)), ItemGroup.DECORATIONS);
    public static final RegistryObject<Block> WHITE_WISTERIA_LEAVES 		= RegistryUtils.createBlock("white_wisteria_leaves", () -> new LeavesBlock(BlockProperties.WISTERIA_LEAVES(MaterialColor.SNOW)), ItemGroup.DECORATIONS);
