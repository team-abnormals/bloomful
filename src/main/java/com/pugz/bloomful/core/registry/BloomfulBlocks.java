...
public class BloomfulBlocks {
    ...
    public static final RegistryObject<Block> PINK_WISTERIA_VINE 			= RegistryUtils.createBlock("hanging_pink_wisteria_leaves", () -> new WisteriaVineBlock(BlockProperties.WISTERIA_LEAVES(MaterialColor.PINK)), ItemGroup.DECORATIONS);
    public static final RegistryObject<Block> BLUE_WISTERIA_VINE 			= RegistryUtils.createBlock("hanging_blue_wisteria_leaves", () -> new WisteriaVineBlock(BlockProperties.WISTERIA_LEAVES(MaterialColor.BLUE)), ItemGroup.DECORATIONS);
    public static final RegistryObject<Block> PURPLE_WISTERIA_VINE 			= RegistryUtils.createBlock("hanging_purple_wisteria_leaves", () -> new WisteriaVineBlock(BlockProperties.WISTERIA_LEAVES(MaterialColor.PURPLE)), ItemGroup.DECORATIONS);
    public static final RegistryObject<Block> WHITE_WISTERIA_VINE 			= RegistryUtils.createBlock("hanging_white_wisteria_leaves", () -> new WisteriaVineBlock(BlockProperties.WISTERIA_LEAVES(MaterialColor.SNOW)), ItemGroup.DECORATIONS);
