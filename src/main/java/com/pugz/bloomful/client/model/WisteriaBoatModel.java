...
@OnlyIn(Dist.CLIENT)
public class WisteriaBoatModel extends EntityModel<WisteriaBoatEntity> {
    ...
    public void render(WisteriaBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    protected void renderPaddle(WisteriaBoatEntity boat, int paddle, float scale, float limbSwing) {
