...
@OnlyIn(Dist.CLIENT)
public class WisteriaBoatModel extends SegmentedModel<WisteriaBoatEntity> {
    ...
    */
   @Override
   public void setRotationAngles(WisteriaBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void func_228244_a_(WisteriaBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
